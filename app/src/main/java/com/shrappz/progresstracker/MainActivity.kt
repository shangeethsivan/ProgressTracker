...
class MainActivity : AppCompatActivity(R.layout.activity_main) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        flash_button.setOnClickListener {
            val imageCapture = requireNotNull(imageCapture)
            val flashMode = imageCapture.flashMode
            imageCapture.flashMode =
                if (flashMode == ImageCapture.FLASH_MODE_ON) ImageCapture.FLASH_MODE_OFF else ImageCapture.FLASH_MODE_ON
            flash_button.text =
                if (flashMode == ImageCapture.FLASH_MODE_ON) "FLASH: OFF" else "FLASH: ON"
